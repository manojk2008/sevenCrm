...
export const clients: Client[] = companyNames.map((name, i) => {
  ...
  return {
    ...
    addresses: [{
      id: `c${i + 1}_a1`,
      street: `${100 + i} Business Park, Phase ${ (i % 3) + 1 }`,
      city,
      state: city === 'Mumbai' || city === 'Pune' ? 'Maharashtra' : city === 'Bangalore' ? 'Karnataka' : city === 'Chennai' ? 'Tamil Nadu' : city === 'Hyderabad' ? 'Telangana' : 'Delhi',
      country: 'India',
