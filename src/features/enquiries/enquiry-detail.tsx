...
export function EnquiryDetail({ open, onOpenChange, enquiry, onEdit }: EnquiryDetailProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="sm:max-w-2xl w-full p-0 flex flex-col bg-slate-50 dark:bg-slate-950 overflow-hidden border-l">
        {/* Header Section */}
        <div className="p-6 bg-card border-b z-10 flex-shrink-0 shadow-sm relative">
